    ...
    <NotificationProvider userId={user.id}>
      <div className="min-h-screen bg-black">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="mb-8">
            <h1 className="text-3xl font-black bg-gradient-to-r from-orange-400 to-amber-500 text-transparent bg-clip-text">Manage Appointments</h1>
            <p className="text-gray-400 mt-2">View and manage all your appointments</p>
          </div>
